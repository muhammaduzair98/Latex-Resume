...
\mobile{(+92) 340 9428486}

\email{uzair.convener@acm.org}
\homepage{www.uzair-resume.herokuapp.com}
\github{muhammaduzair98}
\linkedin{muhammaduzair98}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}Frontend Developer} % Your expertise/fields
\quote{``When you play the Game of Codes, you execute or you fail, there is no middle ground"} % A quote or statement

\makecvfooter{\today}{Muhammad Uzair~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
